...
await sql`DELETE FROM app_records WHERE collection NOT IN ('salons', 'branches', 'staff', 'accounts')`;
...
console.log('All operational data and logs removed. Salons, branches, staff, and salon accounts preserved.');
