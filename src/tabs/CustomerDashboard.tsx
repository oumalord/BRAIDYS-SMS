...
function CustomerDashboard({ account, onBook }: { account: { email?: string; phone?: string }; onBook: () => void }) {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-2xl font-semibold tracking-tight">Appointments</h1></div>
